...
############### For basic release with DB connection  --- 17/10/2024
...
if "conversation_memory" not in st.session_state:
    st.session_state.conversation_memory = EnhancedConversationBufferMemory()

if question := st.chat_input("Type your question here..."):
    st.session_state.show_image = False
    # Add user's question to conversation memory
    st.session_state.conversation_memory.add_user_message(question)
    ...
    if st.session_state["first_prompt"] is None:
        ...
        st.session_state["chat_name"] = f"Chat-{st.session_state['first_prompt']}"
    ...
    # Combine conversation history and summarize if needed
    conversation_summary = st.session_state.conversation_memory.summarize_history()
    ...
    # Add the bot's response to the conversation memory
    st.session_state.conversation_memory.add_bot_message(response)
